    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
     synchronized (this) {
      ...
      if (sensorEvent.sensor.getType() == Sensor.TYPE_ORIENTATION) {
       orientXValue.setText(Float.toString((int)sensorEvent.values[0]));
       orientYValue.setText(Float.toString((int)sensorEvent.values[1]));
       orientZValue.setText(Float.toString((int)sensorEvent.values[2]));       
      }
     }
    }
